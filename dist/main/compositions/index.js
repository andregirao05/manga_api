...
// src/main/compositions/index.ts
var compositions_exports = {};
__export(compositions_exports, {
  makeGetChapterNamesController: () => makeGetChapterNamesController,
  makeGetChaptersController: () => makeGetChaptersController,
  makeGetGenreNamesController: () => makeGetGenreNamesController,
  makeGetLatestUpdatedMangasController: () => makeGetLatestUpdatedMangasController,
  makeGetMangaController: () => makeGetMangaController,
  makeGetMangasByGenreController: () => makeGetMangasByGenreController,
  makeGetPopularMangasController: () => makeGetPopularMangasController,
  makeGetSingleChapterController: () => makeGetSingleChapterController,
  makeSearchMangasController: () => makeSearchMangasController
});
module.exports = __toCommonJS(compositions_exports);
